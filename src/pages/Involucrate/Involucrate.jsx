      ...
      <div className="grid mb-8 border border-gray-200 rounded-lg shadow-sm md:mb-12 md:grid-cols-2 mx-10 lg:mx-32">
        <figure className="flex flex-col items-center justify-center p-8 text-center bg-white border-b border-gray-200 rounded-t-lg md:rounded-t-none md:rounded-tl-lg md:border-r">
          <blockquote className="max-w-2xl mx-auto mb-4 text-gray-500 lg:mb-8">
            ...
            <p className="my-4">
            I am very grateful for the opportunity to have helped at Hogar Santa Marianita. Seeing the smiles of the children when we provided assistance was truly rewarding.
            </p>
          </blockquote>
        ...
        <figure className="flex flex-col items-center justify-center p-8 text-center bg-white border-b border-gray-200 rounded-tr-lg">
          <blockquote className="max-w-2xl mx-auto mb-4 text-gray-500 lg:mb-8">
            ...
            <p className="my-4">
            From the moment I arrived at Hogar Santa Marianita, I was welcomed with open arms by the children and the other volunteers. I was amazed by the ability these children have to find joy in the simplest things.
            </p>
          </blockquote>
          <figcaption className="flex items-center justify-center space-x-3">
            <img
        ...
        <figure className="flex flex-col items-center justify-center p-8 text-center bg-white border-b border-gray-200 rounded-t-lg md:rounded-t-none md:rounded-tl-lg md:border-r">
          <blockquote className="max-w-2xl mx-auto mb-4 text-gray-500 lg:mb-8">
            ...
            <p className="my-4">
            Helping the children at Hogar Santa Marianita was a very enriching experience for me. It was incredibly rewarding to see the smiles on their faces when we gave them attention and love.
            </p>
          </blockquote>
          <figcaption className="flex items-center justify-center space-x-3">
            <img
        ...
        <figure className="flex flex-col items-center justify-center p-8 text-center bg-white border-b border-gray-200 rounded-tr-lg">
          <blockquote className="max-w-2xl mx-auto mb-4 text-gray-500 lg:mb-8">
            ...
            <p className="my-4">
            Seeing the happiness and gratitude of the children at Hogar Santa Marianita when we brought them clothes and toys was one of the most exciting things I've experienced. I would definitely do it again!
            </p>
          </blockquote>
          <figcaption className="flex items-center justify-center space-x-3">
            <img
