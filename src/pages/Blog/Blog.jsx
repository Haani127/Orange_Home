...
import SalaDeJuegos from "../../assets/images/SalaDeJuegos.jpg";
import NinosResando from "../../assets/images/NinosResando.jpg";
import NinoTriste from "../../assets/images/NinoTriste.jpg";
import NinosAula from "../../assets/images/NinosAula.jpg";
import NinosColumpio from "../../assets/images/NinosColumpio.jpg";
  ...
  return (
    <>
      <div className="lg:h-screen lg:-mb-40 mb-10">
        <TituloBanner titulo={titulo} srcImg={SalaDeJuegos} />
      </div>
      <div className="text-gray-900 lg:pt-12 pr-0 pb-14 pl-0 bg-white">
        <div
          className="w-full pt-4 pr-5 pb-6 pl-5 mt-0 mr-auto mb-0 ml-auto space-y-5 sm:py-8 md:py-12 sm:space-y-8 md:space-y-16
          max-w-7xl"
        >
          <div className="flex flex-col-reverse items-center sm:px-5 md:flex-row">
            <div className="flex flex-col items-start justify-center w-full h-full pt-6 pr-0 pb-6 pl-0 mb-6 md:mb-0 md:w-1/2">
              <div
                className="flex flex-col items-start justify-center h-full space-y-3 transform md:pr-10 lg:pr-16
                md:space-y-5"
              >
                <div className="bg-primary flex items-center leading-none rounded-full text-gray-50 pt-1.5 pr-3 pb-1.5 pl-2 uppercase">
                  <p className="inline">
                    <svg
          ...
          <div className="grid grid-cols-12 sm:px-5 gap-x-8 gap-y-16">
            ...
            >
              ...
              />
              <p
                className="bg-secondary flex items-center leading-none text-sm font-medium text-gray-50 pt-1.5 pr-3 pb-1.5 pl-3
            ...
            >
              ...
              />
              <p
                className="bg-quaternary flex items-center leading-none text-sm font-medium text-gray-50 pt-1.5 pr-3 pb-1.5 pl-3
                rounded-full uppercasek uppercase"
              >
                News
              </p>
              <h2 className="text-lg font-bold sm:text-xl md:text-2xl">
