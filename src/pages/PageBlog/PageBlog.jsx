...
export function PageBlog() {
  return (
    <div>
      <div className="max-w-screen-lg mx-auto lg:pt-32 pt-20">
        <div className="mt-10">
          <div className="mb-4 md:mb-0 w-full mx-auto relative">
            <div className="px-4 lg:px-0">
              ...
              <a
                href="#"
                className="py-2 text-secondary inline-flex items-center justify-center mb-2"
              >
                Histories
              </a>
            </div>

            <img src={NinoTriste} className="w-full object-cover lg:rounded" />
          </div>
              ...
              <div className="p-4 border-t border-b md:border md:rounded">
                <div className="flex py-2">
                  <div>
                    ...
                    Together we can provide them with hope!
                    </p>
                  </div>
                </div>
                <p className="text-gray-700 py-3">
                Many children have no home or family. Your donation can make a difference in their lives and provide them with a safe and loving home.
                </p>
                <a
                  href="/donar"
                  type="button"
                  className="mt-5 text-tertiary bg-primary hover:bg-secondary focus:ring-4 focus:outline-none focus:ring-secondary rounded-lg text-base px-4 py-2 text-center mr-3 md:mr-0"
                >
                  Donate Now
                </a>
              </div>
