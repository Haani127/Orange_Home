        ...
        >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2">
                    <div className="p-6 lg:mr-2 bg-gray-800 bg-opacity-50 sm:rounded-lg">
                      ...
                      <div className="flex items-center mt-8 text-gray-600 dark:text-gray-400">
                        ...
                        No. 45, MountRoad, Teynampet,Chennai–600018,TamilNadu, India
                        </div>
                      </div>
                    ...
                    <form className="p-6 flex flex-col justify-center">
                      <div className="flex flex-col">
                        ...
                        <input
                          ...
                          name="name"
                          id="name"
                          placeholder="First Name(s) and Last Name(s)"
          ...
          <div className="lg:w-full lg:h-screen w-screen h-40 lg:px-20">
            <iframe
              ...
              id="gmap_canvas"
              src="https://maps.google.com/maps?q=Mount Road, Chennai&t=&z=15&ie=UTF8&iwloc=&output=embed"
            />
          </div>
        </div>
        <img
